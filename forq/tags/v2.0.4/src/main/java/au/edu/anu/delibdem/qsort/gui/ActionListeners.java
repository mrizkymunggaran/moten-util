...
public class ActionListeners {
	...
	public static ActionListener getNotifyActionListener(final EventType eventType) {
		return getNotifyActionListener(null, eventType);
	}
	
	public static ActionListener getNotifyActionListener(final Object object, final EventType eventType) {
