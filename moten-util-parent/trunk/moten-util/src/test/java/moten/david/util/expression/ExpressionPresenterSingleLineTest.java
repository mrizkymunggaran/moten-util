...
import static moten.david.util.monitoring.lookup.LookupTypeDefault.APPLICATION;
import static moten.david.util.monitoring.lookup.LookupTypeDefault.CONFIGURATION;
