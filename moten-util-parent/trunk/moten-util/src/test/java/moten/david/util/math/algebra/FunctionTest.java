...
public class FunctionTest {
    ...
    public void test() {
        ...
        e = replaceMulti(e, function(g, a, b), function(union, function(gamma, a,
                b), function(mu, a, b)));
        e = replaceMulti(e, function(gamma, function(union, a, b), c), function(
                intersect, function(gamma, a, c), function(gamma, b, c)));
        e = replaceMulti(e, function(gamma, a, function(union, b, c)), function(
        ...
        Function productExpansion = union(gamma(mu(x, y), x), gamma(x, y), mu(
                x, y));
        log("----------");
        log(productExpansion);
        e = replace(productExpansion, y, product(y, z));
        e = replace(e, product(a, b), union(gamma(mu(a, b), a), gamma(a, b),
                mu(a, b)));
    }
