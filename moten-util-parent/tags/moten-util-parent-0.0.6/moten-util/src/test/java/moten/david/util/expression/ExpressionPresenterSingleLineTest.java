...
import static moten.david.util.monitoring.lookup.DefaultLookupType.APPLICATION;
import static moten.david.util.monitoring.lookup.DefaultLookupType.CONFIGURATION;
...
public class ExpressionPresenterSingleLineTest {
    ...
    public void test() {
        ...
        Assert.assertEquals("20 <= APPLICATION.boo", presenter.toString(e.lte(e
                .num(20), e.num("boo", APPLICATION))));
        Assert.assertEquals("ScriptOk(ls -l)", presenter.toString(e
                .scriptOk("ls -l")));
