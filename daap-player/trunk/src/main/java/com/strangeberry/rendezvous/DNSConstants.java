...
// @(#)DNSConstants.java, 1.8, 02/05/2003
//
...
abstract class DNSConstants {
    ...
    final static int CLASS_ANY = 255; // Not a DNS class, but a DNS query class,
                                        // meaning "all classes"
    final static int CLASS_MASK = 0x7FFF; // Multicast DNS uses the bottom 15
                                            // bits to identify the record
                                            // class...
    final static int CLASS_UNIQUE = 0x8000; // ... and the top bit indicates
                                              // that all other cached records are
                                              // now invalid
