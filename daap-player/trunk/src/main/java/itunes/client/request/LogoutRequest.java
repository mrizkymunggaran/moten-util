...
public class LogoutRequest extends Request {
	...
	public LogoutRequest(String server, int port, int sid, ConnectionStatus status)  throws NoServerPermissionException{
		super(server, port,("logout?session-id="+sid), status);
	}
