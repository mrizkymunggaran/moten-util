...
public class ExpressionPresenterMonospacedTest {
	...
	public void test() {
		...
		Assert.assertEquals("20 + boo", presenter.toString(plus(num(20),
				num("boo"))));
		Assert.assertEquals("20 - boo", presenter.toString(minus(num(20),
				num("boo"))));
		Assert.assertEquals("20 * boo", presenter.toString(times(num(20),
				num("boo"))));
		Assert.assertEquals("20 / boo", presenter.toString(divide(num(20),
				num("boo"))));
		Assert.assertEquals("1 + (20 / boo)", presenter.toString(plus(num(1),
				divide(num(20), num("boo")))));
