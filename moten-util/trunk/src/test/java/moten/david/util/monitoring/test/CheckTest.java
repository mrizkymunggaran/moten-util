...
public class CheckTest {
	...
	public void test() {
...

		{
			...
			lookups.put(APPLICATION, factory.create(map));
	...
	public void testUrlLookup() {
		...
		Assert.assertEquals(Level.OK, results.get(one).getLevel());
		Assert.assertEquals(Level.SEVERE, results.get(two).getLevel());
	}
