...
public class MainFrame extends JFrame {
	 ...
	 * @return
	 */
	private JComponent createMultiSplitPane(JComponent tagsPanel,
		...
		DisclosurePanel documentsPanel = new DisclosurePanel(new JLabel(
				"Documents"), filesPanel, null);

		JSplitPane split = new JSplitPane(JSplitPane.VERTICAL_SPLIT);
		split.setOneTouchExpandable(true);
		split.setContinuousLayout(true);
		split.setTopComponent(filesPanel);
