 ...
 * ("disclosed") component. The panel can sprout an optional titled label.
 * 
 * <p>
 * Thanks to: http://lists.apple.com/archives/java-dev/2005/Feb/msg00171.html
 * 
 * ... for the idea.
 */

/*
 * f = new JFrame(); l = new Label("Four score and seven years ago!"); b = new
 * JButton("yo yo yo!"); d = new sim.util.gui.DisclosurePanel(l,b);
 * f.getContentPane().setLayout(new BorderLayout()); f.getContentPane().add(d);
 * f.pack(); f.show();
 */
...
public class DisclosurePanel extends JPanel {
    ...
    public DisclosurePanel(Component abridgedComponent,
            Component disclosedComponent) {
        this(abridgedComponent, disclosedComponent, null);
    }

    public DisclosurePanel(Component abridgedComponent,
            Component disclosedComponent, String borderLabel) {
        ...
        disclosureToggle.addItemListener(new ItemListener() {
            public void itemStateChanged(ItemEvent e) {
                ...
                {
                    DisclosurePanel.this
                            .remove(DisclosurePanel.this.abridgedComponent);
                ...
                {
                    DisclosurePanel.this
                            .remove(DisclosurePanel.this.disclosedComponent);
                    DisclosurePanel.this.add(
